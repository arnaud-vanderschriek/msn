...
public abstract class AbstractInteractableComponent<T extends AbstractInteractableComponent<T>> extends AbstractComponent<T> implements Interactable {
    ...
    public interface AfterEnterFocusListener {
        void afterEnterFocus(FocusChangeDirection direction, Interactable previouslyInFocus);
    }

    public interface AfterLeaveFocusListener {
        void afterLeaveFocus(FocusChangeDirection direction, Interactable previouslyInFocus);
    }

    private AfterEnterFocusListener afterEnterFocusListener;
    private AfterLeaveFocusListener afterLeaveFocusListener;

    public void setAfterEnterFocusListener(AfterEnterFocusListener listener) {
        this.afterEnterFocusListener = listener;
    }

    public void setAfterLeaveFocusListener(AfterLeaveFocusListener listener) {
        this.afterLeaveFocusListener = listener;
    }
    ...
    public final void onEnterFocus(FocusChangeDirection direction, Interactable previouslyInFocus) {
        ...
        if(afterEnterFocusListener != null) {
            afterEnterFocusListener.afterEnterFocus(direction, previouslyInFocus);
        }
    }
    ...
    public final void onLeaveFocus(FocusChangeDirection direction, Interactable nextInFocus) {
        ...
        if(afterLeaveFocusListener != null) {
            afterLeaveFocusListener.afterLeaveFocus(direction, nextInFocus);
        }
    }

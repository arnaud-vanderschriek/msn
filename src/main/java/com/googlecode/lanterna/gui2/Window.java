...
public interface Window extends BasePane {
     ...
     */
    public default void addShortcut(Interactable component, KeyStroke shortcutKeyStroke) {
     ...
     */
    public default void addKeyboardListener(Interactable component,
     ...
     *
     * @param component le composant
     * @param keyType   le type de touche
     * @param handler   le gestionnaire d'événement qui doit être une fonction qui doit retourner un booléen indiquant si
     *                  l'événement doit continuer à être traité par d'autres gestionnaires d'événements éventuels.
     */
    public default void addKeyboardListener(Interactable component,
                                            KeyType keyType,
        ...
        addWindowListener(new WindowListenerAdapter() {
            @Override
            public void onInput(Window basePane, KeyStroke keyStroke, AtomicBoolean deliverEvent) {
                if (keyStroke.getKeyType() == keyType && component.isFocused()) {
                    handler.get();
